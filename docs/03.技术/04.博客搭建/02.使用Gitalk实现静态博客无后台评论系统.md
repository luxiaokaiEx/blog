...
![](https://raw.githubusercontent.com/luxiaokai/image_store/master/blog/QQ%E6%88%AA%E5%9B%BE20191220124134.jpg)
    ...
    [
      'vuepress-plugin-comment',
      {
        ...
        options: {
          ...
          repo: 'blog', // GitHub 仓库
          owner: 'luxiaokai', // GitHub仓库所有者
          admin: ['luxiaokai'], // 对仓库有写权限的人
          distractionFreeMode: false 
        }
      }
    ]
